...
def map_customer(raw: dict) -> dict:
    ...
    return {
        ...
        "data": {
            ...
            # Add any extra fields your agents use:
...
def map_order(raw: dict) -> dict:
    ...
    return {
        ...
        "data": {
            ...
            "status":            raw.get("statuscode", ""),
            "price":             raw.get("totalamount", ""),
            "order_date":        raw.get("createdon", ""),
            "expected_delivery": raw.get("estimatedclosedate", ""),
            "notes":             raw.get("description", ""),
        }
    }
...
def get_customer(identifier: str):
    ...
    # 1. Try as order number (opportunity)
    if identifier.upper().startswith("ORD-") or identifier.isdigit():
        try:
            ...
            pass  # fall through to phone/email search
