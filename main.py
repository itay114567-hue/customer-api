...
def escalate(
    ...
    try:
        ...
        # עדיפות לפי intent: 1=נמוכה, 2=רגילה, 3=גבוהה, 4=דחופה
        intent_priority = {
            "Refund+Request":      2,  # רגילה
            "Complaint":           3,  # גבוהה
            "Human+Agent+Request": 2,  # רגילה
            "Unknown+Query":       1,  # נמוכה
        }
        # Fireberry priority override - try numeric string
        priority_map = {"low": "1", "medium": "2", "high": "3", "urgent": "4"}
        ...
        payload = {
            ...
            "prioritycode": intent_priority.get(intent, 2),
            "statuscode":   1,
        }
