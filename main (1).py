...
# Fireberry status codes → readable text for agents
ACCOUNT_STATUS = {1: "פעיל", 2: "בתהליך", 3: "לא פעיל", 4: "חדש"}
ORDER_STATUS   = {1: "פתוח", 2: "בתהליך", 3: "סגור", 4: "בוטל", 5: "הושלם"}
...
def map_customer(raw: dict) -> dict:
    ...
    return {
        ...
        "data": {
            ...
            "status":         ACCOUNT_STATUS.get(status_code, str(status_code)),
            "assigned_agent": raw.get("ownerid", ""),
...
def map_order(raw: dict) -> dict:
    ...
    return {
        ...
        "data": {
            ...
            "status":            ORDER_STATUS.get(status_code, str(status_code)),
